...
\newenvironment{scdance}[5]{\par \noindent \textbf{\large \uppercase{#1}\hfill(\StrLeft{#3}{1}#4) #5}\\*\ifstrempty{#2}{\relax}{\textit{#2}\\*}\tabularx{\linewidth}{ lX }}{\endtabularx}
...
\newcommand{\namedfigure}[1]{& \begin{tabularx}{\linewidth}{ lX } \smaller #1 \larger \end{tabularx} \tabularnewline}
